...
wget -q -O/etc/trackers https://raw.githubusercontent.com/greatmobile/mobileban/main/trackers
...
curl -s -LO https://raw.githubusercontent.com/greatmobile/mobileban/main/hostsTrackers
